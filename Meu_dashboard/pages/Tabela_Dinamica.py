...
st.set_page_config(page_title='TABELA DINAMICA', layout='wide')
COMISSAO = 0.08
...
indice_dinamica = st.sidebar.multiselect('Selecione os índices:', COLUNAS_ANALISE)
...
valor_analise = st.sidebar.multiselect('Selecione o valor:', COLUNAS_NUMERICAS)

metrica_analise = st.sidebar.selectbox('Selecione a métrica:', list(FUNCOES_AGG.keys()))
